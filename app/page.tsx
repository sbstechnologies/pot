...
export default function Home() {
  ...
  return (
    <>
      ...
      <section
        id="unit"
        className="bg-[#f5f2ee] px-6 xs:px-6 sm:px-6 md:px-30 lg:px-60 xl:px-85 xxl:px-80 pt-24 sm:pt-28 md:pt-32 pb-10 sm:pb-12 md:pb-16 overflow-x-hidden"
      >
        <div className="max-w-[1920px] mx-auto">
          {/* TOP TEXT ROW */}
    ...
    letter-spacing: -0.02em sm:text-[18px] tracking-[-0.02em] text-[#f5f2ee] letter-spacing: -0.02em; leading-none   px-3 py-1  whitespace-nowrap"
      ...
      <section
        id="amenities"
        className="bg-[#0c2340]  px-6 xs:px-6 sm:px-6 md:px-30 lg:px-60 xl:px-85 xxl:px-80 py-14 md:py-20"
      >
        <div className="max-w-[1920px] mx-auto">
      ...
      <section
        id="neighborhood"
        className="bg-[#f1eee9]  px-6 xs:px-6 sm:px-6 md:px-30 lg:px-60 xl:px-85 xxl:px-80 py-12 sm:py-14 md:py-20"
      >
      ...
      <section className="bg-[#f1eee9] px-6 xs:px-6 sm:px-6 md:px-30 lg:px-60 xl:px-85 xxl:px-80 pb-14 sm:pb-16">
      ...
      <section
        id="residents"
        className="bg-[#0c2340]  px-6 xs:px-6 sm:px-6 md:px-30 lg:px-60 xl:px-85 xxl:px-80 py-12 md:py-20 text-white overflow-hidden relative"
      >
      ...
      <section className="w-full bg-[#f5f2ed] py-14 sm:py-16 md:py-20 font-[Plus_Jakarta_Sans] antialiased select-none">
        <div className="mx-auto max-w-[1920px] px-6 xs:px-6 sm:px-6 md:px-30 lg:px-60 xl:px-85 xxl:px-80">
          {/* HEADER */}
      ...
      <section
        id="leasing-cta"
        className="bg-[#0c1a3a] px-6 xs:px-6 sm:px-6 md:px-30 lg:px-60 xl:px-85 xxl:px-80 py-16 sm:py-[100px] scroll-mt-[72px] relative overflow-hidden text-white"
      >
        {/* Radial Glow */}
        <div
