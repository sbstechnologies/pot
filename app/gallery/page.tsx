...
export default function Gallery() {
  ...
  return (
    <>
      ...
      {/* HERO SECTION */}
      <section className="bg-[#1E3872] text-[#F5F2ED] px-10 xs:px-6 sm:px-6 md:px-30 lg:px-60 xl:px-85 xxl:px-80 py-24 md:py-28 font-[Plus_Jakarta_Sans]">
      ...
      {/* FILTER BAR */}
      <div className="bg-white border-b border-[#e5e1d8] px-10 xs:px-6 sm:px-6 md:px-30 lg:px-60 xl:px-85 xxl:px-80 py-4 font-[Plus_Jakarta_Sans]">
      ...
      {/* GALLERY SECTION */}
      <section className="bg-[#F5F2ED] px-10 xs:px-6 sm:px-6 md:px-30 lg:px-60 xl:px-85 xxl:px-80 py-10 md:py-14">
