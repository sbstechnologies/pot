  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#F5F2ED] rounded-t-[28px] shadow-2xl border-t border-[#d8d2c7] max-h-[82vh] overflow-y-auto">
        <div className="sticky top-0 bg-[#F5F2ED] px-10 xs:px-8 sm:px-8 md:px-30 lg:px-60 xl:px-85 xxl:px-80 pt-4 pb-6 border-b border-[#ddd7cc]">
        ...
        <div className="px-10 xs:px-8 sm:px-8 md:px-30 lg:px-60 xl:px-85 xxl:px-80 py-8">
          {/* desktop */}
...
export default function Floor() {
  ...
  return (
    <>
      ...
      <PromoCardWidget />
      <section className="relative overflow-hidden bg-[#1f376d] text-[#F5F2ED] min-h-[620px] px-10 xs:px-8 sm:px-8 md:px-30 lg:px-60 xl:px-85 xxl:px-80 pt-[84px] pb-20">
      ...
      <section className="bg-[#F5F2ED]  py-16 px-10 xs:px-8 sm:px-8 md:px-30 lg:px-60 xl:px-85 xxl:px-80">
      ...
      <section className="bg-[#F5F2ED] pb-24 px-10 xs:px-8 sm:px-8 md:px-30 lg:px-60 xl:px-85 xxl:px-80">
