...
export default function Contact() {
  return (
    <>
      ...
      {/* ===== HERO ===== */}
      <section className="relative overflow-hidden bg-[#1f376d]  pt-32 pb-24 text-white px-10 xs:px-8 sm:px-8 md:px-30 lg:px-60 xl:px-85 xxl:px-80">
      ...
      <section className="bg-[#f5f2ed] px-10 xs:px-8 sm:px-8 md:px-30 lg:px-60 xl:px-85 xxl:px-80 py-12 font-[Plus_Jakarta_Sans] md:px-10 lg:px-24 md:py-16">
      ...
      {/* ===== OFFER CTA ===== */}
      <section className="bg-[#f5f2ed] pb-14 px-10 xs:px-8 sm:px-8 md:px-30 lg:px-60 xl:px-85 xxl:px-80 md:pb-20">
