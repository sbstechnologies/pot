...
export default function Blog() {
  ...
  return (
    <>
      <PromoCardWidget />
      <HeaderOther />
      <section className="bg-[#1f376d] text-white pt-32 pb-24 px-10 xs:px-6 sm:px-6 md:px-30 lg:px-60 xl:px-85 xxl:px-80 relative overflow-hidden">
      ...
      {/* FEATURED CARD */}
      <section className="bg-[#f5f2ed] px-10 xs:px-6 sm:px-6 md:px-30 lg:px-60 xl:px-85 xxl:px-80 pt-10 md:pt-14 pb-24 relative z-10">
      ...
      {/* BLOG GRID */}
      <section className="bg-[#f5f2ed] px-10 xs:px-6 sm:px-6 md:px-30 lg:px-60 xl:px-85 xxl:px-80 pb-24">
        <div className="max-w-[1920px] mx-auto">
