...
========================= */}
        ...
        <motion.p className="font-[Plus_Jakarta_Sans] text-[18px] font-normal leading-[1.9] tracking-[0.01em] text-[#4B4B4B] mb-5">
          ...
          convenience. Parks on Taylor and LiveNJoy Management are not
...
========================= */}
        ...
        <motion.p className="font-[Plus_Jakarta_Sans] text-[18px] font-normal leading-[1.9] tracking-[0.01em] text-[#4B4B4B] mb-5">
          Welcome to Parks on Taylor. By accessing and using this website, you
        ...
        <motion.p className="font-[Plus_Jakarta_Sans] text-[18px] font-normal leading-[1.9] tracking-[0.01em] text-[#4B4B4B] mb-5">
          Neither Parks on Taylor, LiveNJoy Management, nor any third parties
          provide any warranty or guarantee regarding the absolute accuracy,
          completeness, or timeliness of the information displayed on this
          website. All{" "}
          <strong className="font-semibold text-[#232323]">
            rental incentives
          </strong>
          ...
          acknowledge and agree that Parks on Taylor and LiveNJoy Management
        ...
        <motion.p className="font-[Plus_Jakarta_Sans] text-[18px] font-normal leading-[1.9] tracking-[0.01em] text-[#4B4B4B] mb-10">
          Parks on Taylor is committed to compliance with all federal, state,
          and local fair housing laws. We operate under a{" "}
          <strong className="font-semibold text-[#232323]">
        ...
        <motion.p className="font-[Plus_Jakarta_Sans] text-[18px] font-normal leading-[1.9] tracking-[0.01em] text-[#4B4B4B]">
          ...
          disabilities. We actively design and maintain the Parks on Taylor
