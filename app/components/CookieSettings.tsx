      ...
      <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-[460px] rounded-[20px] bg-[#FFFDF6] px-5 py-4 shadow-[0_12px_35px_rgba(0,0,0,0.15)]">
          ...
          <button
            type="button"
            onClick={onClose}
            className="absolute right-4 top-4 flex h-7 w-7 items-center justify-center rounded-full text-[#213A70] transition hover:bg-gray-100"
          >
          ...
          <h2 className="mb-2.5 text-[15px] font-bold text-[#213A70]">
            ...
            <div className="flex items-start justify-between gap-4 border-b border-[#E1DFD7] pb-3">
              <div className="flex-1">
                ...
                <p className="mt-1.5 text-[11px] leading-4 text-[#66645C]">
                  ...
                  secure logins, and loading your floor options.
                </p>
              </div>
            ...
            <div className="flex items-start justify-between gap-4 border-b border-[#E1DFD7] py-2.5">
              <div className="flex-1">
                ...
                <p className="mt-1.5 text-[11px] leading-4 text-[#66645C]">
                  Helps us understand how visitors interact with the website through 
                  tools like Microsoft Clarity so we can improve the user experience.
                </p>
              </div>
            ...
            <div className="flex items-start justify-between gap-4 pt-2.5">
              <div className="flex-1">
                ...
                <p className="mt-1.5 text-[11px] leading-4 text-[#66645C]">
                  Used to track the effectiveness of our leasing
                  advertisements and display relevant promotions to you
                </p>
              </div>
              <div className="flex items-center justify-center pt-0.5">
                <Toggle
